...
public static class ExceptionHandlerExtensions
{
  ...
  public static IApplicationBuilder MyExceptionHandler(this IApplicationBuilder app, ILogger? logger = null, bool logStructuredException = false)
  {
    app.UseExceptionHandler(errApp =>
    {
      errApp.Run(async ctx =>
          ...
          var request_string = await new StreamReader(ctx.Request.Body).ReadToEndAsync();
          Console.WriteLine("request_string: " + request_string);
